window.addEventListener('load', function(){
  ...
  const World = function (url) {
    ...
    this.map = [
      ...
      ['A3', 'B3', 'C3', 'C3', 'C3', 'C3', 'C3', 'C3', 'C3', 'C3', 'C3', 'E4', 'F4', 'G3', 'H3'],
      ...
      ['A7', 'B7', 'C7', 'C7', 'C7', 'C7', 'D7', 'E7', 'F7', 'C7', 'C7', 'C7', 'C7', 'G7', 'H7'],
      ['A8', 'B8', 'C8', 'C8', 'C8', 'C8', 'D8', 'E8', 'F8', 'C8', 'C8', 'C8', 'C8', 'G8', 'H8']
    ];
  ...
  const Object = function (url, x ,y, width, height) {
   ...
   const Bullet = function (x, y, direction) {
     MovingObject.call(this, 'hydrogenbomb.png', x, y, 50, 50, 15)
     
    this.source_x = 0;
    this.source_y = 0;
    this.source_width = 400;
    this.source_height = 302;
    this.offset_top = 0;
    this.offset_left = 0;
    this.offset_right = 0;
    this.offset_bottom = 0;
  ...
  const update = function (){
    ...
    [hillaryclinton, ammo].forEach((object) => {
  ...
  const render = function () {
    ...
    context.rect(
      ammo.getLeft(),
      ammo.getTop(),
      ammo.getRight() - ammo.getLeft(),
      ammo.getBottom() - ammo.getTop()
    )
    context.stroke()
    */
